...
include { count_words } from './05_workflow_outputs_utils'
include { clean_counts as clean_most } from './05_workflow_outputs_utils'
include { clean_counts as clean_least } from './05_workflow_outputs_utils'
...
workflow {
    ...
    publish:
    least_common = ch_least_cleaned
    most_common = ch_most_cleaned
}
